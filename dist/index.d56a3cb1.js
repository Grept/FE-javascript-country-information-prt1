...
* */ async function createCountryList() {
    try {
        ...
        const countryList = await _axiosDefault.default.get("https://restcountries.com/v3/all");
        // SORT COUNTRY LIST
        ...
        for(let i = 0; i < listElementCollection.length; i++)unorderedListElement.appendChild(listElementCollection[i]);
    } catch (e) {
        console.log(e);
    }
}
